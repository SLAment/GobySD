...
Two input files, `male_coverage_hap1.txt` and `male_coverage_hap2.txt`, were produced by the `MaleKmers.smk` pipeline and available in `../02_MaleKmers/reports`. Other files were produced with RADsex as described in the paper.
